...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UInv_HighlightableStaticMesh_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UInv_Highlightable_NoRegister, (int32)VTABLE_OFFSET(UInv_HighlightableStaticMesh, IInv_Highlightable), false },  // 3833498601
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_Interaction_Inv_HighlightableStaticMesh_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UInv_HighlightableStaticMesh, UInv_HighlightableStaticMesh::StaticClass, TEXT("UInv_HighlightableStaticMesh"), &Z_Registration_Info_UClass_UInv_HighlightableStaticMesh, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInv_HighlightableStaticMesh), 2756391646U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_Interaction_Inv_HighlightableStaticMesh_h_812766633(TEXT("/Script/Inventory"),
	Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_Interaction_Inv_HighlightableStaticMesh_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_Interaction_Inv_HighlightableStaticMesh_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
