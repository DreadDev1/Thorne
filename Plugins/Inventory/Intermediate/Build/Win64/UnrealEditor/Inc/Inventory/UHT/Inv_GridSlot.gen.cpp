...
#include "Inventory/Public/Widgets/Inventory/GridSlots/Inv_GridSlot.h"
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UInv_GridSlot);
UClass* Z_Construct_UClass_UInv_GridSlot_NoRegister()
{
	return UInv_GridSlot::StaticClass();
}
...
template<> INVENTORY_API UClass* StaticClass<UInv_GridSlot>()
{
	return UInv_GridSlot::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_Widgets_Inventory_GridSlots_Inv_GridSlot_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UInv_GridSlot, UInv_GridSlot::StaticClass, TEXT("UInv_GridSlot"), &Z_Registration_Info_UClass_UInv_GridSlot, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInv_GridSlot), 3718566104U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_Widgets_Inventory_GridSlots_Inv_GridSlot_h_2534644273(TEXT("/Script/Inventory"),
	Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_Widgets_Inventory_GridSlots_Inv_GridSlot_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_Widgets_Inventory_GridSlots_Inv_GridSlot_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
