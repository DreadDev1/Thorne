...
#include "Inventory/Public/Interaction/Inv_Highlightable.h"
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UInv_Highlightable_UnHighlight_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UInv_Highlightable, nullptr, "UnHighlight", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UInv_Highlightable_UnHighlight_Statics::Function_MetaDataParams), Z_Construct_UFunction_UInv_Highlightable_UnHighlight_Statics::Function_MetaDataParams) };
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UInv_Highlightable);
UClass* Z_Construct_UClass_UInv_Highlightable_NoRegister()
{
	return UInv_Highlightable::StaticClass();
}
struct Z_Construct_UClass_UInv_Highlightable_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UInv_Highlightable_Highlight, "Highlight" }, // 514494597
		{ &Z_Construct_UFunction_UInv_Highlightable_UnHighlight, "UnHighlight" }, // 829463911
	};
...
template<> INVENTORY_API UClass* StaticClass<UInv_Highlightable>()
{
	return UInv_Highlightable::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_Interaction_Inv_Highlightable_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UInv_Highlightable, UInv_Highlightable::StaticClass, TEXT("UInv_Highlightable"), &Z_Registration_Info_UClass_UInv_Highlightable, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInv_Highlightable), 3833498601U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_Interaction_Inv_Highlightable_h_1809383956(TEXT("/Script/Inventory"),
	Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_Interaction_Inv_Highlightable_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_Interaction_Inv_Highlightable_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
