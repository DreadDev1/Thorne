...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UInv_InventoryStatics);
UClass* Z_Construct_UClass_UInv_InventoryStatics_NoRegister()
{
	return UInv_InventoryStatics::StaticClass();
}
struct Z_Construct_UClass_UInv_InventoryStatics_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UInv_InventoryStatics_GetInventoryComponent, "GetInventoryComponent" }, // 2166688344
	};
...
template<> INVENTORY_API UClass* StaticClass<UInv_InventoryStatics>()
{
	return UInv_InventoryStatics::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_InventoryManagement_Utils_Inv_InventoryStatics_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UInv_InventoryStatics, UInv_InventoryStatics::StaticClass, TEXT("UInv_InventoryStatics"), &Z_Registration_Info_UClass_UInv_InventoryStatics, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInv_InventoryStatics), 3749380242U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_InventoryManagement_Utils_Inv_InventoryStatics_h_3833375144(TEXT("/Script/Inventory"),
	Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_InventoryManagement_Utils_Inv_InventoryStatics_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Thorne_Plugins_Inventory_Source_Inventory_Public_InventoryManagement_Utils_Inv_InventoryStatics_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
